...
class Notice extends Component {
  ...
  handleNoticeSubmit = () => {
    ...
    const url = "https://deployment-backend-webapp.onrender.com/user/addnotice";
    const token = localStorage.getItem("token");
    const notice = document.getElementsByClassName(
      "noticeBlock-mainBody-wrapper-editor"
    )[0].textContent;

    if (notice === "" && this.state.img === null && this.state.pdf === null)
      return;
    ...
    document.getElementsByClassName("noticeBlock")[0].style.transform =
      "scale(0,0)";
    document.getElementsByClassName("overlayMaterial")[0].style.transform =
      "scale(0,0)";
  };
  ...
  handleClickToOpenOption = (cnt) => {
    ...
    var optionsMenu = document.getElementsByClassName(
      "single-notice-container-options-menu"
    );
          ...
          <div>
            <div className="noticeBlock">
              <div class="noticeBlock-heading">
                Create a post here &emsp; &emsp; &emsp; &emsp; &emsp; &emsp;
                <span
                  className="noticeBlock-cancelButton"
                  onClick={this.cancelNoticeBlock}
                >
                  <strong>X</strong>
                </span>
              </div>
              <div className="noticeBlock-mainBody">
                <div className="noticeBlock-mainBody-wrapper">
                  <div
                    className="noticeBlock-mainBody-wrapper-editor"
              ...
              <div className="noticeBlock-postButton">
                <div
                  className="noticeBlock-postButton-post"
                  onClick={this.handleNoticeSubmit}
                >
                  Post
                </div>
