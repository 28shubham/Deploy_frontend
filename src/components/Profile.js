...
class Profile extends Component {
  ...
  handleEditing = (field) => {
    if (field === "editAbout") {
      ...
      //responsible div
      let res_div = document.getElementsByClassName(
        "profilePage-container-about-content"
      )[0];
      console.log(res_div);
  ...
  handleCoverPicUpload = (field) => {
    if (field === "cancel") {
      ...
      const url =
        "https://deployment-backend-webapp.onrender.com/user/uploadCover";
      const token = localStorage.getItem("token");
      const options = {
        method: "POST",
        headers: {
  ...
  render() {
    ...
    let skills =
      this.props.profile.user.skills === undefined
        ? []
        : this.props.profile.user.skills;
    let links =
      this.props.profile.user.socialLinks === undefined
        ? []
        : this.props.profile.user.socialLinks;
    let attendencePercentage =
      (this.props.profile.user.classesAttended /
        this.props.profile.user.totalClasses) *
      100;
    ...
    let url = null;
    if (
      this.props.profile.user.resume !== null &&
      this.props.profile.user.resume !== undefined
    ) {
        ...
        <div className="profilePage-container">
          <div className="profilePage-container-details">
            <div className="profilePage-container-details-cover">
              ...
              {this.state.coverPicOptions === true && (
                <div className="profilePage-container-details-cover-options">
                  &nbsp;
                  <i
                    class="fas fa-times"
                    onClick={() => this.handleCoverPicUpload("cancel")}
                  ></i>
                  <br />
                  <br />
                  <i
                    class="fas fa-check-circle"
                    onClick={() => this.handleCoverPicUpload("done")}
                  ></i>
                </div>
              )}
              <img alt="coverpiv" src={coverPic === null ? cover : coverPic} />
            </div>
            <div className="profilePage-container-details-profile-detail">
              <div className="profilePage-container-details-profile-detail-profile">
                ...
                {this.state.dpPicOptions === true && (
                  <div className="profilePage-container-details-dp-options">
                    &nbsp;
                    <i
                      class="fas fa-times"
                      onClick={() => this.handledpPicUpload("cancel")}
                    ></i>
                    &nbsp;&nbsp;&nbsp;
                    <i
                      class="fas fa-check-circle"
                      onClick={() => this.handledpPicUpload("done")}
                    ></i>
                  </div>
                )}
                <img alt="profile pic" src={dpPic === null ? dp : dpPic} />
              </div>
              <div className="profilePage-container-details-profile-detail-detail">
                <span className="profilePage-container-details-profile-detail-detail-name">
                  {name}
                </span>
                <br />
                <span className="profilePage-container-details-profile-detail-detail-branch">
                  {branch}
                </span>
                <br />
                {sem === "1" && (
                  <span className="profilePage-container-details-profile-detail-detail-sem">
                    {sem}
                    <sup>st</sup> Semester{" "}
                  </span>
                )}
          ...
          <div className="profilePage-container-about">
            <div className="profilePage-container-about-heading">
              About
              {profileId === authId && (
                <span onClick={() => this.handleEditing("editAbout")}>
                  <i class="far fa-edit"></i>
                </span>
              )}
            </div>
            <div
              className="profilePage-container-about-content"
          ...
          {desig === "stu" && (
            <div className="profilePage-container-skills">
              <div className="profilePage-container-skills-heading">
                Skills
                {profileId === authId && (
                  <span onClick={() => this.handleEditing("editSkills")}>
                ...
                {this.state.editSkills && (
                  <span>
                    <input
                      ...
                      onChange={(e) =>
                        this.handleInputChange("newSkill", e.target.value)
                      }
                    />
                    <span
              ...
              <div className="profilePage-container-skills-content">
                {skills.map((skill, idx) => {
                  return (
                    <div
                      className="profilePage-container-skills-content-skill"
                      id={`${idx}dx`}
                      onMouseEnter={() =>
                        this.handleDeleteShow(`${idx}dx`, "skill")
                      }
                      onMouseLeave={() =>
                        this.handleDeleteUnShow(`${idx}dx`, "skill")
                      }
                    >
                      {skill}
                      <div
                        className="skill-Canceller"
                        id={`${idx}dy`}
          ...
          <div className="profilePage-container-links">
            <div className="profilePage-container-links-heading">
              Social profile
              {profileId === authId && (
                <span onClick={() => this.handleEditing("editLinks")}>
                  <i class="fas fa-plus"></i>
                </span>
              )}
              {this.state.editLinks && (
                <span>
                  <input
                    ...
                    onChange={(e) =>
                      this.handleInputChange("newPlatform", e.target.value)
                    }
                  />
                  <input
                    type="text"
                    ...
                    onChange={(e) =>
                      this.handleInputChange("newLink", e.target.value)
                    }
                  />
                  <span
            ...
            <div className="profilePage-container-links-content">
              {links.map((prof, idx) => {
                return (
                  <div
                    className="profilePage-container-links-content-skill"
                    id={`${idx}dlp`}
                    onMouseEnter={() =>
                      this.handleDeleteShow(`${idx}dlp`, "link")
                    }
                    onMouseLeave={() =>
                      this.handleDeleteUnShow(`${idx}dlp`, "link")
                    }
                  >
                    <a href={prof.data.link} target="_blank" rel="noreferrer">
                      {prof.data.platform}
                    </a>
                    <div
                      className="link-Canceller"
                      id={`${idx}dlpc`}
            ...
            <div className="profilePage-container-info-content">
              {desig === "stu" && (
                <div className="profilePage-container-info-content-info">
                  <div className="profilePage-container-info-content-info-name">
                    Attendence
                  </div>
                  <div className="profilePage-container-info-content-info-value">
              ...
              {desig === "stu" && (
                <div className="profilePage-container-info-content-info">
                  ...
                  {url !== null && (
                    <div
                      className="profilePage-container-info-content-info-value"
                      id="ppciciv"
                    >
                      <a href={url} target="_blank" rel="noreferrer">
                        Resume <i class="fas fa-file-pdf" />
                      </a>
                    </div>
                  )}
                  {profileId === authId && (
                    <div className="profilePage-container-info-content-info-upload">
                  ...
                  {profileId === authId && url !== null && (
                    <div className="profilePage-container-info-content-info-upload">
                      <label
                        className="profilePage-container-info-content-info-upload-label"
