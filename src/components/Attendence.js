...
class Attendence extends React.Component {
  ...
  handleSubmit = () => {
    ...
    const url =
      "https://deployment-backend-webapp.onrender.com/attendence/studentList";
    const options = {
      method: "POST",
      headers: {
  ...
  render() {
    ...
    console.log(this.props.auth.user.monthlyAttendence);
    console.log(this.props.auth.user.monthlyAttendence[0].ca);
    let Jan =
      (this.props.auth.user.monthlyAttendence[0].ca /
        this.props.auth.user.monthlyAttendence[0].tc) *
      100;
    let Feb =
      (this.props.auth.user.monthlyAttendence[1].ca /
        this.props.auth.user.monthlyAttendence[1].tc) *
      100;
    let Mar =
      (this.props.auth.user.monthlyAttendence[2].ca /
        this.props.auth.user.monthlyAttendence[2].tc) *
      100;
    let Apr =
      (this.props.auth.user.monthlyAttendence[3].ca /
        this.props.auth.user.monthlyAttendence[3].tc) *
      100;
    let May =
      (this.props.auth.user.monthlyAttendence[4].ca /
        this.props.auth.user.monthlyAttendence[4].tc) *
      100;
    let June =
      (this.props.auth.user.monthlyAttendence[5].ca /
        this.props.auth.user.monthlyAttendence[5].tc) *
      100;
    let July =
      (this.props.auth.user.monthlyAttendence[6].ca /
        this.props.auth.user.monthlyAttendence[6].tc) *
      100;
    let Aug =
      (this.props.auth.user.monthlyAttendence[7].ca /
        this.props.auth.user.monthlyAttendence[7].tc) *
      100;
    let Sep =
      (this.props.auth.user.monthlyAttendence[8].ca /
        this.props.auth.user.monthlyAttendence[8].tc) *
      100;
    let Oct =
      (this.props.auth.user.monthlyAttendence[9].ca /
        this.props.auth.user.monthlyAttendence[9].tc) *
      100;
    let Nov =
      (this.props.auth.user.monthlyAttendence[10].ca /
        this.props.auth.user.monthlyAttendence[10].tc) *
      100;
    let Dec =
      (this.props.auth.user.monthlyAttendence[11].ca /
        this.props.auth.user.monthlyAttendence[11].tc) *
      100;
    // if(isNaN(Jan))Jan = 0  ;
    if (isNaN(Dec)) Dec = 0;
    if (isNaN(Nov)) Nov = 0;
      ...
      return (
        <div className="attend1">
          <div className="preattend">
            ...
            <br />
            <select
              className="attendencelabel"
              onChange={(e) => this.handleChange("monthS", e.target.value)}
            >
          ...
          {this.state.studentList !== null &&
            this.state.studentList.length > 0 && (
              <div className="upload">
                <button onClick={() => this.handleUploadAttendence()}>
                  Upload
                </button>
              </div>
            )}
