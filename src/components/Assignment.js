...
class Assignment extends Component {
  ...
  handleButtonChanger = () => {
    if (this.state.createClicked === true) {
      let creater = document.getElementsByClassName(
        "assignment-container-creater-details"
      )[0];
  ...
  uploadAssignment = () => {
    ...
    if (assignPicture)
      formdata.append("assignPicture", this.state.assignPicture);
    console.log("Sending Data");
    const url = `https://deployment-backend-webapp.onrender.com/assignment/d`;
  ...
  render() {
    ...
    if (
      this.state.singleAssignmentObject !== null &&
      this.state.singleAssignmentObject.pdf !== undefined
    ) {
    ...
    if (
      this.state.singleAssignmentObject !== null &&
      this.state.singleAssignmentObject.submission.length > 0
    ) {
    ...
    return (
      <div className="assignment">
        <div className="assignment-container">
          {!this.state.singleAssignmentMode && (
            <div className="assignment-container-creater">
              <div className="assignment-container-creater-details">
                <div
                  className="assignment-creater-canceller"
                ...
                <div className="assignment-container-creater-details-name">
                  <input
                    ...
                    onChange={(e) =>
                      this.handleChange("subName", e.target.value)
                    }
                  />
                  <br />
                  <input
                    ...
                    className="subjectName"
                    onChange={(e) =>
                      this.handleChange("assignmentName", e.target.value)
                    }
                  />
                  <br />
                </div>
                <div className="assignment-container-creater-details-select">
                  ...
                  <select
                    className="subjectName"
                    onChange={(e) =>
                      this.handleChange("branch", e.target.value)
                    }
                  >
                  ...
                  <select
                    className="subjectName"
                    onChange={(e) =>
                      this.handleChange("semester", e.target.value)
                    }
                  >
              ...
              {!this.state.createClicked && (
                <div
                  className="assignment-container-creater-button"
                  onClick={() => this.handleButtonChanger()}
                >
                  Create Assignment
                </div>
          ...
          {!this.state.singleAssignmentMode && (
            <div className="assignment-container-display">
          ...
          {this.state.singleAssignmentMode && (
            <div className="assignment-container-single-content">
              <div className="assignment-container-single-content-first">
                ...
                <div className="assignment-container-single-content-first-actualcontent">
                  {this.state.singleAssignmentObject.pdf && (
                    <div>
                      <a
                        href={assignmentQuestionUrl}
                        target="_blacnk"
                        rel="noreferrer"
                      >
                        PDF
                  ...
                  {this.state.singleAssignmentObject.img && (
                    <div>
                      <img
                        alt="Assignment.Jpg"
                        src={this.state.singleAssignmentObject.img}
                      />
                    </div>
                  )}
                </div>
              ...
              <div className="assignment-container-single-content-second">
                ...
                <div className="assignment-container-single-content-second-actualcontent">
                  {studentSubmission.map((submit) => {
                    return (
                      <div>
                        <a href={submit.url}>{submit.name}</a>
                      </div>
                    );
                  })}
                </div>
              ...
              <div className="assignment-container-single-content-third">
                ...
                <div className="assignment-container-single-content-third-actualcontent">
                  {this.state.singleAssignmentObject.nosubmission.map(
                    (nosubmit) => {
                      return <div>{nosubmit.name}</div>;
                    }
                  )}
                </div>
              </div>
